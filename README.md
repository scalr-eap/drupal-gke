# Drupal POD in GKE cluster

Creates a Dupal Pod in an GKE Cluster in the given Region.
...
1. Fork or clone the Source repo (https://github.com/scalr-eap/drupal-gke)
